...
const Gallery = ({ position }) => {
  ...
  In this example, we add two buttons ("Scroll Left" and "Scroll Right") that, when clicked, adjust the scroll position of the .scroll-container by a specific amount. You can change the amount by which you want to scroll by modifying the value in scrollContainer.scrollLeft -= 100 and scrollContainer.scrollLeft += 100.
  
  You can customize this JavaScript to fit your needs and control the scroll position as desired.
    ...
    <Box>
      ...
      >
        <Animated>
          ...
          <ArrowForwardIosIcon sx={{zIndex: 1}}/>
        </Animated>
      </Box>
    </Box>
  );
