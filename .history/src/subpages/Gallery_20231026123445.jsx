  ...
  return (
    <Box sx={{ backgroundColor: grey[900] }}>
      ...
      >
        <Animated>
          <Box sx={{ display: "flex" }}>
            <Typography variant="h5" color={grey[100]} onClick={() => toggleMedia(false)}>Images</Typography>
            <Typography  variant="h5" color={grey[100]} sx={{ mx: "0.25rem" }}>
              /
            </Typography>
            <Typography  variant="h5" color={grey[100]} onClick={() => toggleMedia(false)}>Trailer</Typography>
          </Box>
          <Box
            sx={{
              display: "flex",
