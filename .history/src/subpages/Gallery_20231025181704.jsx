      ...
      >
        <Animated>
          ...
          <CardMedia
            ...
            sx={{
              opacity: showPreview ? 1 : 0.5, // 1 for visible, 0 for hidden
              position: "absolute",
              width: "900px",
              bottom: "50%",
              left: "50%",
              transform: "translate(-50%, 50%)",
              transition: "opacity 0.2s", // Apply transition to the opacity property
              pointerEvents: showPreview ? "auto" : "none", // Enable or disable pointer events
            }}
          />
        </Animated>
      </Box>
