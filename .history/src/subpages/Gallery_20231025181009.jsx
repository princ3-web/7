...
import { Box, CardMedia, nativeSelectClasses } from "@mui/material";
    ...
    <Box>
      ...
      >
        <Animated>
          ...
          >
            {images.map((item, n) => (
              <CardMedia component="img" alt="" src={item} sx={{ width: "280px", m: "0.1rem" }} onClick={() => setItem(nativeSelectClasses)} />
            ))}
          </Box>
          <CardMedia
            component="img"
